...
// Standard connection options BullMQ expects for its blocking clients.
const connectionOptions = {
  maxRetriesPerRequest: null,
  enableReadyCheck: false,
};

// Parse the URL once so we can hand IORedis either a URL-string or an
// options object consistently.
...
function sharedRedis() {
  if (!_sharedClient) _sharedClient = makeRedisClient();
